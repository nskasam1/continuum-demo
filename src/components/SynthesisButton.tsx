  ...
  return (
    <div className="relative flex justify-center py-6 md:h-full md:flex-col md:items-center md:py-0 md:pt-[120px]">
      ...
      <motion.button
        ...
        className="relative z-10 h-11 w-44 shrink-0 rounded-full font-mono text-xs tracking-wider text-white uppercase shadow-[0_6px_16px_rgba(11,31,58,0.28)] disabled:cursor-default enabled:cursor-pointer md:rotate-[-90deg]"
      >
        {label}
      </motion.button>
    </div>
